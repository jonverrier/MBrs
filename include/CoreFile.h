...
private:
   ...
   CoreImageTagList readExifSubjectTags(Exiv2::Image::AutoPtr& image, HUint& fileError);
   
   void writeExifSubjectTags(Exiv2::Image::AutoPtr& image, const CoreImageTagList& tags, HUint& fileError) const;
   
   CoreImageTagList readIptcSubjectTags(Exiv2::Image::AutoPtr& image, HUint& fileError);

   void writeIptcSubjectTags(Exiv2::Image::AutoPtr& image, const CoreImageTagList& tags, HUint& fileError) const;

   CoreImageTagList readXmpSubjectTags(Exiv2::Image::AutoPtr& image, HUint& fileError);

   void writeXmpSubjectTags(Exiv2::Image::AutoPtr& image, const CoreImageTagList& tags, HUint& fileError) const;
